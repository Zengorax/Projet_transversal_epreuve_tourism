...
<body style="background-image: url(./image/home.png);">
    ...
    <header class="mb-auto py-3 sticky-top" style="padding-right: 16px; background-color: rgba(55, 54, 54, 0.5);">
        <div class="container d-flex flex-wrap justify-content-between align-items-center">
            ...
            <nav class="nav nav-masthead justify-content-center">
                <a class="nav-link fw-bold py-1 px-2 active" aria-current="page" href="./index.php">Accueil</a>
    ...
    <main class="px-3 d-flex vstack gap-3 w-100 d-flex align-items-center justify-content-center row"
        style="height: 85.9vh;">
        <div class="d-flex flex-wrap align-items-center justify-content-center rounded col-9 col-lg-6"
            style="background-color: rgba(55, 54, 54, 0.5);">
            <h1>Horizon Sportif</h1>
            <p class="lead text-center">
                La meilleure agence de voyage pour vos envies d'escapades et de vous dépasser physiquement.
                Découvrez nos meilleurs circuits à travers le monde entier pour pratiquer des activités sportives en
                famille ou entre amis.
            </p>
        </div>
        <p class="lead px-3 text-center">
