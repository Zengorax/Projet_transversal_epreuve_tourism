...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT Id_Client, Identifiant, password FROM Client WHERE Identifiant = :Identifiant";

        if ($stmt = $pdo->prepare($sql)) {


            $stmt->bindParam(":Identifiant", $param_username, PDO::PARAM_STR);
    ...
    <div class="signup-container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow-lg" style="min-width: 350px; max-width: 400px;">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <p>Pas de compte? <a href="Register.php">S'enregistré</a></p>
            </form>
