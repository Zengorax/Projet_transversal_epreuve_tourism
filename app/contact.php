...
<body>
  ...
  <header class="mb-auto py-3 border-bottom">
    <div class="container d-flex flex-wrap justify-content-between align-items-center">
      ...
      <nav class="nav nav-masthead justify-content-center">
        ...
        <a class="nav-link fw-bold py-1 px-2 active" href="./contact.php">Contact</a>
      </nav>
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end text-small shadow">
          ...
          <li><a class="dropdown-item" href="login.php">Connéction</a></li>
  ...
  <div class="container py-5">
    <h2 class="text-center fw-bold mb-4">Nous contacter</h2>
